 ...
 * nums.length = 10.
 * Hàm kiểm tra nums.length <= 1 là False.
 * Theo dõi trạng thái (nums được sửa đổi tại chỗ):
| Bước | i (đọc) | k (ghi) | Mảng nums (Trạng thái hiện tại) | Điều kiện (nums[i] !== nums[i-1]) | Hành động | Mảng nums (Sau hành động) | k (Sau hành động) |
|---|---|---|---|---|---|---|---|
| Khởi tạo | - | 1 | [0, 0, 1, 1, 1, 2, 2, 3, 3, 4] | - | k = 1 | [0, 0, 1, 1, 1, 2, 2, 3, 3, 4] | 1 |
| i = 1 | 1 | 1 | [0, **0**, 1, 1, 1, 2, 2, 3, 3, 4] | nums[1](0) !== nums[0](0) (False) | Bỏ qua (nums[1] trùng lặp) | [0, 0, 1, 1, 1, 2, 2, 3, 3, 4] | 1 |
| i = 2 | 2 | 1 | [0, 0, **1**, 1, 1, 2, 2, 3, 3, 4] | nums[2](1) !== nums[1](0) (True) | nums[1] = nums[2] ([0, **1**, ...]), k++ | [0, 1, 1, 1, 1, 2, 2, 3, 3, 4] | 2 |
| i = 3 | 3 | 2 | [0, 1, 1, **1**, 1, 2, 2, 3, 3, 4] | nums[3](1) !== nums[2](1) (False) | Bỏ qua (nums[3] trùng lặp) | [0, 1, 1, 1, 1, 2, 2, 3, 3, 4] | 2 |
| i = 4 | 4 | 2 | [0, 1, 1, 1, **1**, 2, 2, 3, 3, 4] | nums[4](1) !== nums[3](1) (False) | Bỏ qua (nums[4] trùng lặp) | [0, 1, 1, 1, 1, 2, 2, 3, 3, 4] | 2 |
| i = 5 | 5 | 2 | [0, 1, 1, 1, 1, **2**, 2, 3, 3, 4] | nums[5](2) !== nums[4](1) (True) | nums[2] = nums[5] ([0, 1, **2**, ...]), k++ | [0, 1, 2, 1, 1, 2, 2, 3, 3, 4] | 3 |
| i = 6 | 6 | 3 | [0, 1, 2, 1, 1, 2, **2**, 3, 3, 4] | nums[6](2) !== nums[5](2) (False) | Bỏ qua (nums[6] trùng lặp) | [0, 1, 2, 1, 1, 2, 2, 3, 3, 4] | 3 |
| i = 7 | 7 | 3 | [0, 1, 2, 1, 1, 2, 2, **3**, 3, 4] | nums[7](3) !== nums[6](2) (True) | nums[3] = nums[7] ([0, 1, 2, **3**, ...]), k++ | [0, 1, 2, 3, 1, 2, 2, 3, 3, 4] | 4 |
| i = 8 | 8 | 4 | [0, 1, 2, 3, 1, 2, 2, 3, **3**, 4] | nums[8](3) !== nums[7](3) (False) | Bỏ qua (nums[8] trùng lặp) | [0, 1, 2, 3, 1, 2, 2, 3, 3, 4] | 4 |
| i = 9 | 9 | 4 | [0, 1, 2, 3, 1, 2, 2, 3, 3, **4**] | nums[9](4) !== nums[8](3) (True) | nums[4] = nums[9] ([0, 1, 2, 3, **4**, ...]), k++ | [0, 1, 2, 3, 4, 2, 2, 3, 3, 4] | 5 |
